...
export default function WorkList() {
  ...
  return (
    <div className="page-wrapper flex items-center justify-center w-full ">
      <div className="project-list w-full  items-center justify-center flex flex-col z-50 h-full ">
