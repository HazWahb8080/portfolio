...
function MagneticHeader({title,link}) {
  return (
                  ...
                  speed={1}
                  borderRadius='30px'>
                      <h1 className="rounded-full hover:scale-125 transition ease-in-out duration-500 z-50 bg-[#011638]/80 bg-opacity-90 backdrop-filter backdrop-blur-lg py-9 -mb-20 px-8 shadow-xl view
