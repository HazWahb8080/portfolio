...
function Marqueex() {
  return (
    <div data-scroll-section  className="flex pt-12 py-3 flex-col items-start justify-center target ">
      
      <div data-scroll  className="font-Marc items-start flex-col justify-start flex target ">
        <h1 data-scroll   title="my skills" className="flex flex-col  px-5 self-center 
