...
function Work() {
  ...
  return (
      <div data-scroll-container className="h-full w-full items-center justify-center flex">
      ...
      <div className="h-full w-full  flex flex-col items-start justify-start " >
          <div
          className={` border-b border-white/5 w-full smooth duration-500 ${ !view ?  " hidden bg-[#EEC643]" : " flex bg-transparent"}`} >
          <Header/>
        </div>
   ...
   { !view && <motion.div
    ...
    { view && <div className="mt-12 py-6 md:px-6 w-full flex border-b border-white/50 flex-col items-center justify-center ">
        ...
        <div className="text-white font-Popp text-sm md:text-xl  py-3 px-4 w-full
         flex items-center justify-evenly space-x-4 " >
            <div className={` ${activeTab === isActive1 ? "tab-works-active " : "tab-works"} `} >
                <h1 ref={ref1} onClick={()=>setActiveTab(ref1.current?.innerText)}
                > Full-Stack </h1>
            </div>
            <div  className={` ${activeTab === isActive2 ? " tab-works-active " : 'tab-works'} `}>
                <h1 ref={ref2} onClick={()=>setActiveTab(ref2.current?.innerText)}> Mini-Awwwards </h1>
            </div>
            <div  className={` ${activeTab === isActive3 ? " tab-works-active " : 'tab-works'} `}>
                <h1 ref={ref3} onClick={()=>setActiveTab(ref3.current?.innerText)}> Experimentals </h1>
            </div>
        </div>
    </div>}
    {/* content */}
    ...
    <div className="w-full py-6 px-6 2xl:px-24 flex  items-center justify-center h-[2000px] scrollbar-hide overflow-y-scroll pt-12 ">
        ...
        />
        <Acc title={"Mini Awwwrds #2"} subtitle={"playing around with Framer Motion Animate Presence and Shared Layout"} link={"https://pages-anim.vercel.app/"}
         t1={"Reactjs"} 
         t2={"Framer Motion"} 
         t3={"React Router"} 
         t4={"SASS"} 
        />
         <Acc title={"Mini Awwwrds #3"} subtitle={"Google Storeis website recreation"} link={"https://awww3.vercel.app/"}
          t1={"ReactJs"} 
          t2={"GSAP ScrollTrigger"} 
          t3={"GSAP Timeline"} 
         />
        <Acc title={"Stack 3D Project"} subtitle={"Vintage Random rotation and scale on hover"} link={"https://stack3d.vercel.app/"}
         t1={"Reactjs"} 
         t2={"GSAP"} 
         t3={"Lodash"} 
         t4={"SASS"}
        ...
        <Acc title={"Awwwards Layout Project"} subtitle={"Modern incredible Awwwards winner website recreation"} link={"https://layout-zeta.vercel.app/"}
         t1={"ReactJs"} 
         t2={"Framer Motion"} 
         t3={"React-Router"} 
         t4={"Sass"}
        ...
        <Acc title={"Mini-Amazon"} subtitle={"when i was learning Redux and Stripe"}
         ...
         t5={"RestApi"}
        />
        <Acc title={"Not-Medium"} subtitle={"playing around with SanityCms and TypeScript"}
         ...
         t4={"Next ISR"} 
        />
         <Acc title={"NFTs Drop Marketplace"} subtitle={"first interaction with nft stuff and i really enjoyed it"}
          ...
          t5={"TailWind Css"}
         />
         <Acc title={"Skew Scrolling Effect"} subtitle={"Modern incredible Awwwards winner website recreation Effect"}
        ...
        <Acc title={"TypeWriter Effect"} subtitle={" needed to create epic realistic typewriter effect and done with gsap in 2 lines of code "}
